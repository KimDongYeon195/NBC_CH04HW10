...
ACh04Hw10Character::ACh04Hw10Character()
{
...
void ACh04Hw10Character::NotifyControllerChanged()
{
...
void ACh04Hw10Character::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ACh04Hw10Character::Move);
...
void ACh04Hw10Character::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ACh04Hw10Character::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
